...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0015_alter_doctor_planned_therapy_sessions'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='thread',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='main.thread'),
        ),
        migrations.AddField(
            model_name='chatmessage',
            name='user',
